...
import { Casemanagers } from './casemanagers.model';
...
@Component({
  selector: 'app-casemanagers',
  templateUrl: './casemanagers.component.html',
  styleUrls: ['./casemanagers.component.scss']
})
export class CasemanagersComponent implements OnInit, AfterViewInit, OnDestroy {
