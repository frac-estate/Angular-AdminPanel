  ...
  import { Casemanagers } from './checkingdatatable.model';
  ...
  @Component({
    selector: 'app-checkingdatatable',
    templateUrl: './checkingdatatable.component.html',
    styleUrls: ['./checkingdatatable.component.scss']
  })
  export class CheckingdatatableComponent implements OnInit, AfterViewInit, OnDestroy  { 
  ...
  constructor(private modalService: NgbModal, public formBuilder: FormBuilder, private http: HttpClient,private router: Router,) {
  ...
  let postData = {
    ...
    let apiurl = this.BaseURL+'/admin/staffs';
  ...
  openChckbxModal(content:string) {
  ...
  checkuncheckall()
  {
    console.log("checkuncheckall 1",this.isChecked);
      ...
      console.log("checkuncheckall 2",this.isChecked);  
      //this.rerender();
  }
  ...
  checkuncheck(e)
  {
    ...
    console.log(e.target.checked);
     ...
     console.log("checkuncheck 2",e);
    */
    //var chckbxItems = $('.chckbx').length;
    var chckbxItems = $('input.chckbx:checked').length
    console.log(chckbxItems);
