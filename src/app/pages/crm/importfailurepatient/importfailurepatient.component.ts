  ...
  import { Casemanagers } from './importfailurepatient.model';
...
@Component({
  selector: 'app-importfailurepatient',
  templateUrl: './importfailurepatient.component.html',
  styleUrls: ['./importfailurepatient.component.scss']
})
export class ImportfailurepatientComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  */
  ...
  private _fetchData() {
    ...
    //entity/admin/import/failedpatients
     let apiurl = this.BaseURL+'/admin/import/failedpatients';
     console.log(apiurl);
  ...
  openEditModal(id,sh360id,content:string) {
   ...
   var header = {
    ...
    //URL: localhost:11009/entity/admin/import/failedpatient/details?id=6097d5205c68899b54792d8d
    let apiurl = this.BaseURL+'/admin/import/failedpatient/details?id='+id;
    console.log(apiurl);
  ...
  */
  ...
  openDeleteModalOkay(id,sh360id,content:string) {
   ...
   var header = {
    ...
    let apiurl = this.BaseURL+'/admin/import/failedpatient?id='+id;
    console.log(apiurl);
